...
function isTransientVeoError(message: string | undefined | null): boolean {
  ...
  return (
    ...
    m.includes("generation failed") ||
    m.includes("unable to generate") ||
    m.includes("failed to generate") ||
    m.includes("generation incomplete") ||
...
function isVeoNotProcessedYet(message: string | undefined | null): boolean {
  ...
  return (
    ...
    m.includes("input video must be a video that was generated by veo") ||
    m.includes("must be processed") ||
    m.includes("processing video") ||
    m.includes("video is not ready")
  );
}

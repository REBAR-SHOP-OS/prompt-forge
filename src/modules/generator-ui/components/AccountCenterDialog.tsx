...
// (Email/Profile). Shows the caller's profile, usage & credits, remaining
// generations, and a daily-spend activity calendar.
//
// Read-only. All usage data comes from the shared useUsageStats hook (single
// source of truth with UsageStatsPopover). No billing writes, no schema
// changes, no route changes — opening it never resets the workspace/generator.
        ...
        <div className="max-h-[calc(90vh-4rem)] space-y-5 overflow-y-auto px-5 py-5 text-sm">
          ...
          <section className="flex items-center gap-3">
            <Avatar className="h-12 w-12">
              <AvatarFallback className="bg-white/10 text-zinc-200">
                {initialsFor(email)}
              </AvatarFallback>
            </Avatar>
            ...
            <>
              ...
              <section>
                ...
                <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
                  ...
                  <div className="rounded-md border border-white/10 bg-white/[0.02] p-3">
                    <CalendarClock className="mb-1 h-4 w-4 text-zinc-400" />
                  ...
                  <div className="rounded-md border border-white/10 bg-white/[0.02] p-3">
                    <Film className="mb-1 h-4 w-4 text-zinc-400" />
                  ...
                  <div className="rounded-md border border-white/10 bg-white/[0.02] p-3">
                    <Gauge className="mb-1 h-4 w-4 text-zinc-400" />
                ...
                <div className="mt-3 space-y-2">
                  <div className="space-y-1">
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className="tabular-nums text-zinc-300">{dailyPct.toFixed(0)}%</span>
                    </div>
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className="tabular-nums text-zinc-300">{monthPct.toFixed(0)}%</span>
                    </div>
              ...
              <section>
                ...
                <div className="space-y-1.5 rounded-md border border-white/10 bg-white/[0.02] p-3 text-xs">

                        ...
                        <div className="space-y-1.5">
                          {taglines.map((t, i) => (
                            <button
                              ...
                              className="block w-full rounded-lg border border-border bg-accent/30 px-3 py-2 text-left text-xs text-foreground transition hover:border-amber-300/50 hover:bg-amber-300/10 disabled:cursor-not-allowed disabled:opacity-50"
                            >
                              “{t}”
                            </button>
                          ))}

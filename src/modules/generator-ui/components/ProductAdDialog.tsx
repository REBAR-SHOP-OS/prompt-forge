...
const SCENE_TEMPLATES: SceneTemplate[] = [
  ...
  { id: 'high-rise-tower', label: { en: 'High-Rise Tower Construction', fa: 'ساخت برج بلندمرتبه' }, icon: '🏗️', group: G_CONSTRUCTION, prompt: 'High-rise tower construction environment: a partially built concrete tower rising floor by floor, tower cranes swinging loads, workers on open decks and safety nets against a city skyline.' },
  { id: 'steel-framework', label: { en: 'Skyscraper Steel Framework', fa: 'اسکلت فلزی آسمان‌خراش' }, icon: '🏙️', group: G_CONSTRUCTION, prompt: 'Skyscraper steel framework environment: exposed structural steel beams and columns being bolted and welded high above the city, ironworkers walking girders with sparks raining down.' },
  { id: 'concrete-pour', label: { en: 'Concrete Pour / Casting', fa: 'بتن‌ریزی' }, icon: '🧱', group: G_CONSTRUCTION, prompt: 'Concrete pour and casting environment: a boom pump delivering wet concrete into formwork, workers vibrating and screeding the surface, gray slurry and formwork panels everywhere.' },
  { id: 'rebar-site', label: { en: 'Rebar & Reinforcement Site', fa: 'آرماتوربندی و میلگرد' }, icon: '🔩', group: G_CONSTRUCTION, prompt: 'Rebar and reinforcement environment: dense grids of steel reinforcing bars tied together across a slab or column cage, workers bending and fastening bars, orange rust texture and geometric patterns.' },
  { id: 'tower-crane', label: { en: 'Tower Crane Operation', fa: 'عملیات جرثقیل برجی' }, icon: '🏗️', group: G_CONSTRUCTION, prompt: 'Tower crane operation environment: a towering crane lifting heavy loads across a construction site, long jib against the sky, cables tensioning and materials rising slowly with cinematic scale.' },
  { id: 'bridge-construction', label: { en: 'Highway / Bridge Construction', fa: 'ساخت بزرگراه / پل' }, icon: '🌉', group: G_CONSTRUCTION, prompt: 'Highway and bridge construction environment: massive concrete piers, cantilevered spans reaching across a valley, launching gantries and segmental deck sections with epic infrastructure scale.' },
  { id: 'road-paving', label: { en: 'Road Paving & Asphalt', fa: 'آسفالت و راه‌سازی' }, icon: '🛣️', group: G_CONSTRUCTION, prompt: 'Road paving environment: an asphalt paver laying fresh hot mix, steam rising, rollers compacting the surface and crews in high-vis vests under harsh daylight.' },
  { id: 'tunnel-boring', label: { en: 'Tunnel Boring / Excavation', fa: 'حفاری تونل' }, icon: '🚧', group: G_CONSTRUCTION, prompt: 'Tunnel boring and excavation environment: a giant tunnel boring machine cutting through rock, dim underground lighting, dust, conveyor belts of spoil and curved concrete tunnel segments.' },
  { id: 'foundation-earthworks', label: { en: 'Foundation & Earthworks', fa: 'پی‌کنی و خاک‌برداری' }, icon: '⛏️', group: G_CONSTRUCTION, prompt: 'Foundation and earthworks environment: excavators digging deep pits, piling rigs driving foundations, mounds of soil, muddy access roads and heavy machinery churning the ground.' },
  { id: 'scaffolding-facade', label: { en: 'Scaffolding & Facade Work', fa: 'داربست و نماکاری' }, icon: '🧗', group: G_CONSTRUCTION, prompt: 'Scaffolding and facade work environment: multi-level metal scaffolding wrapping a building, mesh netting, workers installing cladding and glass panels high on the elevation.' },
  { id: 'residential-build', label: { en: 'Residential Housing Build', fa: 'ساخت مسکونی' }, icon: '🏘️', group: G_CONSTRUCTION, prompt: 'Residential housing construction environment: rows of half-built homes with timber framing, brickwork and roof trusses, stacks of materials and a developing suburban site.' },
  { id: 'prefab-modular', label: { en: 'Prefab / Modular Assembly', fa: 'ساخت پیش‌ساخته / ماژولار' }, icon: '📦', group: G_CONSTRUCTION, prompt: 'Prefabricated modular construction environment: cranes lowering factory-built room modules into place like giant building blocks, clean precise assembly and rapid stacking of units.' },
  { id: 'demolition-site', label: { en: 'Demolition Site', fa: 'تخریب' }, icon: '💥', group: G_CONSTRUCTION, prompt: 'Demolition environment: an excavator with a hydraulic breaker tearing down a structure, collapsing walls, billowing dust clouds and piles of rubble and twisted rebar.' },
  { id: 'dam-hydro', label: { en: 'Dam / Hydro Construction', fa: 'ساخت سد / نیروگاه آبی' }, icon: '🌊', group: G_CONSTRUCTION, prompt: 'Dam and hydro construction environment: a massive concrete dam wall under construction, spillways, diversion channels, huge machinery and turbulent water against monumental scale.' },
  { id: 'refinery-build', label: { en: 'Oil & Gas / Refinery Build', fa: 'ساخت پالایشگاه نفت و گاز' }, icon: '🛢️', group: G_CONSTRUCTION, prompt: 'Oil and gas plant construction environment: a maze of steel piping, pressure vessels and distillation towers being erected, module lifts, flare stacks and industrial complexity.' },
  { id: 'renewable-farm', label: { en: 'Solar / Wind Farm Construction', fa: 'ساخت نیروگاه خورشیدی / بادی' }, icon: '☀️', group: G_CONSTRUCTION, prompt: 'Renewable energy construction environment: cranes raising towering wind turbine sections and blades, rows of solar panels being installed across open land under a wide sky.' },
  { id: 'site-survey', label: { en: 'Site Groundbreaking / Survey', fa: 'نقشه‌برداری و کلنگ‌زنی' }, icon: '📐', group: G_CONSTRUCTION, prompt: 'Site groundbreaking and survey environment: surveyors with total stations and tripods, marking stakes and string lines across cleared land, early-stage bare ground with heavy equipment arriving.' },
  { id: 'deep-piling', label: { en: 'Deep Foundation Piling', fa: 'شمع‌کوبی عمیق' }, icon: '🪛', group: G_CONSTRUCTION, prompt: 'Deep foundation piling environment: tall piling rigs driving steel and concrete piles deep into the ground, rhythmic hammering, mud, drilling augers and reinforced pile caps.' },
  { id: 'formwork-shuttering', label: { en: 'Formwork & Shuttering', fa: 'قالب‌بندی' }, icon: '🪜', group: G_CONSTRUCTION, prompt: 'Formwork and shuttering environment: intricate timber and metal formwork panels assembled for columns and slabs, props and shoring towers, workers aligning shutters before a pour.' },
  { id: 'precast-yard', label: { en: 'Precast Concrete Yard', fa: 'کارگاه قطعات پیش‌ساخته بتنی' }, icon: '🧊', group: G_CONSTRUCTION, prompt: 'Precast concrete yard environment: rows of factory-cast beams, panels and hollow-core slabs stacked in a storage yard, gantry cranes moving elements and steam-cured concrete surfaces.' },
  { id: 'masonry-brick', label: { en: 'Masonry & Bricklaying', fa: 'بنایی و آجرچینی' }, icon: '🧱', group: G_CONSTRUCTION, prompt: 'Masonry and bricklaying environment: workers laying bricks and blocks in neat courses, mortar troweled between joints, string lines and rising walls with textured brickwork detail.' },
  { id: 'structural-welding', label: { en: 'Structural Welding Close-up', fa: 'جوشکاری سازه' }, icon: '🔥', group: G_CONSTRUCTION, prompt: 'Structural welding close-up environment: intense arc-welding sparks flying off steel joints, glowing molten metal, welder in protective gear and dramatic high-contrast light on heavy beams.' },
  { id: 'curtain-wall', label: { en: 'Glass Curtain Wall Install', fa: 'نصب نمای شیشه‌ای' }, icon: '🪟', group: G_CONSTRUCTION, prompt: 'Glass curtain wall installation environment: large reflective glazing panels being lifted by suction cranes and fixed onto a building facade, mullion grids and mirrored sky reflections.' },
  { id: 'roofing-waterproofing', label: { en: 'Roofing & Waterproofing', fa: 'سقف‌سازی و عایق‌کاری' }, icon: '🏠', group: G_CONSTRUCTION, prompt: 'Roofing and waterproofing environment: workers laying membranes, tiles and insulation across a rooftop, torch-on sealing, exposed trusses and safety harnesses against the sky.' },
  { id: 'mep-install', label: { en: 'MEP / Pipes & Ducts Install', fa: 'نصب تأسیسات و لوله' }, icon: '🔧', group: G_CONSTRUCTION, prompt: 'MEP installation environment: overhead runs of HVAC ducts, pipes and cable trays being fitted through an unfinished ceiling, workers on lifts connecting mechanical services.' },
  { id: 'electrical-wiring', label: { en: 'Electrical Wiring & Conduit', fa: 'سیم‌کشی برق' }, icon: '⚡', group: G_CONSTRUCTION, prompt: 'Electrical wiring environment: electricians pulling colorful cables through conduits, distribution boards and busbars being wired, exposed junction boxes across a building under fit-out.' },
  { id: 'interior-fitout', label: { en: 'Interior Fit-Out / Drywall', fa: 'نازک‌کاری داخلی' }, icon: '🚪', group: G_CONSTRUCTION, prompt: 'Interior fit-out environment: metal stud framing and drywall partitions being erected, plasterboard sheets, taping and dust, an unfinished interior taking shape under work lights.' },
  { id: 'plastering-finishing', label: { en: 'Plastering & Finishing', fa: 'گچ‌کاری و پرداخت' }, icon: '🎨', group: G_CONSTRUCTION, prompt: 'Plastering and finishing environment: workers skimming smooth plaster onto walls, sanding and painting, clean matte surfaces emerging in a near-complete interior.' },
  ...
  { id: 'metro-railway', label: { en: 'Metro / Railway Construction', fa: 'ساخت مترو / راه‌آهن' }, icon: '🚆', group: G_CONSTRUCTION, prompt: 'Metro and railway construction environment: track ballast and rails being laid, sleepers aligned, overhead catenary masts and tunnel or viaduct sections with heavy rail machinery.' },
  { id: 'airport-runway', label: { en: 'Airport / Runway Construction', fa: 'ساخت فرودگاه / باند' }, icon: '🛬', group: G_CONSTRUCTION, prompt: 'Airport runway construction environment: vast concrete and asphalt paving stretching to the horizon, line-marking crews, graders and rollers on a massive flat airfield site.' },
  { id: 'port-marine', label: { en: 'Port & Marine Works', fa: 'کارهای بندری و دریایی' }, icon: '⚓', group: G_CONSTRUCTION, prompt: 'Port and marine construction environment: quay walls and jetties being built over water, piling barges, gantry cranes and concrete caissons against the sea.' },
  { id: 'canal-water', label: { en: 'Canal / Water Infrastructure', fa: 'زیرساخت آبی / کانال' }, icon: '💧', group: G_CONSTRUCTION, prompt: 'Water infrastructure construction environment: concrete canals, culverts and treatment basins under construction, diversion channels, formwork and earth-moving along waterways.' },
  { id: 'pipeline-laying', label: { en: 'Pipeline Laying', fa: 'لوله‌گذاری خطوط انتقال' }, icon: '🧯', group: G_CONSTRUCTION, prompt: 'Pipeline laying environment: long trenches with large steel pipes being welded and lowered by sidebooms across open terrain, coating stations and a linear construction spread.' },
  { id: 'power-plant', label: { en: 'Power Plant Construction', fa: 'ساخت نیروگاه' }, icon: '🏭', group: G_CONSTRUCTION, prompt: 'Power plant construction environment: massive turbine halls, cooling towers and boiler structures under erection, thick pipework, cranes and monumental industrial scale.' },
  { id: 'warehouse-logistics', label: { en: 'Warehouse / Logistics Build', fa: 'ساخت انبار / لجستیک' }, icon: '🏬', group: G_CONSTRUCTION, prompt: 'Warehouse and logistics construction environment: huge steel portal frames and cladding of a distribution center, vast concrete floor slabs and long-span roof structures.' },
  { id: 'stadium-arena', label: { en: 'Stadium / Arena Construction', fa: 'ساخت استادیوم / سالن' }, icon: '🏟️', group: G_CONSTRUCTION, prompt: 'Stadium and arena construction environment: sweeping curved roof trusses and tiered concrete seating bowls under construction, giant cranes and dramatic structural geometry.' },
  { id: 'night-construction', label: { en: 'Nighttime Construction Site', fa: 'کارگاه ساختمانی شبانه' }, icon: '🌙', group: G_CONSTRUCTION, prompt: 'Nighttime construction environment: a site lit by powerful floodlights and machinery headlights, glowing dust, long shadows, welding sparks and cranes silhouetted against a dark sky.' },
  // Urban & Modern

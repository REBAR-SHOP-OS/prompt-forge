      ...
      {!disabled && (
        <div className="absolute -top-9 left-1/2 z-40 flex -translate-x-1/2 items-center gap-1">
          <button
            ...
            title="Drag preview"
            className="grid h-7 w-7 cursor-grab touch-none select-none place-items-center rounded-md border border-white/10 bg-black/60 text-zinc-300 backdrop-blur transition hover:border-white/25 hover:text-zinc-100 active:cursor-grabbing"
          >
          ...
          <button
            ...
            className="grid h-7 w-7 place-items-center rounded-md border border-white/10 bg-black/60 text-zinc-300 backdrop-blur transition hover:border-white/25 hover:text-zinc-100"
          >

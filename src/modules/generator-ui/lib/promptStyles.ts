...
export const SCENE_STYLES: StyleItem[] = [
  ...
  { id: 'site-survey', label: 'Site Groundbreaking / Survey', icon: '📐', group: G_CONSTRUCTION, prompt: 'Site groundbreaking and survey environment: surveyors with total stations and tripods, marking stakes and string lines across cleared land, early-stage bare ground with heavy equipment arriving.' },
  { id: 'deep-piling', label: 'Deep Foundation Piling', icon: '🪛', group: G_CONSTRUCTION, prompt: 'Deep foundation piling environment: tall piling rigs driving steel and concrete piles deep into the ground, rhythmic hammering, mud, drilling augers and reinforced pile caps.' },
  { id: 'formwork-shuttering', label: 'Formwork & Shuttering', icon: '🪜', group: G_CONSTRUCTION, prompt: 'Formwork and shuttering environment: intricate timber and metal formwork panels assembled for columns and slabs, props and shoring towers, workers aligning shutters before a pour.' },
  { id: 'precast-yard', label: 'Precast Concrete Yard', icon: '🧊', group: G_CONSTRUCTION, prompt: 'Precast concrete yard environment: rows of factory-cast beams, panels and hollow-core slabs stacked in a storage yard, gantry cranes moving elements and steam-cured concrete surfaces.' },
  { id: 'masonry-brick', label: 'Masonry & Bricklaying', icon: '🧱', group: G_CONSTRUCTION, prompt: 'Masonry and bricklaying environment: workers laying bricks and blocks in neat courses, mortar troweled between joints, string lines and rising walls with textured brickwork detail.' },
  { id: 'structural-welding', label: 'Structural Welding Close-up', icon: '🔥', group: G_CONSTRUCTION, prompt: 'Structural welding close-up environment: intense arc-welding sparks flying off steel joints, glowing molten metal, welder in protective gear and dramatic high-contrast light on heavy beams.' },
  { id: 'curtain-wall', label: 'Glass Curtain Wall Install', icon: '🪟', group: G_CONSTRUCTION, prompt: 'Glass curtain wall installation environment: large reflective glazing panels being lifted by suction cranes and fixed onto a building facade, mullion grids and mirrored sky reflections.' },
  { id: 'roofing-waterproofing', label: 'Roofing & Waterproofing', icon: '🏠', group: G_CONSTRUCTION, prompt: 'Roofing and waterproofing environment: workers laying membranes, tiles and insulation across a rooftop, torch-on sealing, exposed trusses and safety harnesses against the sky.' },
  { id: 'mep-install', label: 'MEP / Pipes & Ducts Install', icon: '🔧', group: G_CONSTRUCTION, prompt: 'MEP installation environment: overhead runs of HVAC ducts, pipes and cable trays being fitted through an unfinished ceiling, workers on lifts connecting mechanical services.' },
  { id: 'electrical-wiring', label: 'Electrical Wiring & Conduit', icon: '⚡', group: G_CONSTRUCTION, prompt: 'Electrical wiring environment: electricians pulling colorful cables through conduits, distribution boards and busbars being wired, exposed junction boxes across a building under fit-out.' },
  { id: 'interior-fitout', label: 'Interior Fit-Out / Drywall', icon: '🚪', group: G_CONSTRUCTION, prompt: 'Interior fit-out environment: metal stud framing and drywall partitions being erected, plasterboard sheets, taping and dust, an unfinished interior taking shape under work lights.' },
  { id: 'plastering-finishing', label: 'Plastering & Finishing', icon: '🎨', group: G_CONSTRUCTION, prompt: 'Plastering and finishing environment: workers skimming smooth plaster onto walls, sanding and painting, clean matte surfaces emerging in a near-complete interior.' },
  { id: 'elevator-shaft', label: 'Elevator / Lift Shaft Work', icon: '🛗', group: G_CONSTRUCTION, prompt: 'Elevator shaft construction environment: a deep vertical concrete shaft with guide rails, hoist cables and technicians installing the lift car and machinery under dramatic top light.' },
  { id: 'metro-railway', label: 'Metro / Railway Construction', icon: '🚆', group: G_CONSTRUCTION, prompt: 'Metro and railway construction environment: track ballast and rails being laid, sleepers aligned, overhead catenary masts and tunnel or viaduct sections with heavy rail machinery.' },
  { id: 'airport-runway', label: 'Airport / Runway Construction', icon: '🛬', group: G_CONSTRUCTION, prompt: 'Airport runway construction environment: vast concrete and asphalt paving stretching to the horizon, line-marking crews, graders and rollers on a massive flat airfield site.' },
  { id: 'port-marine', label: 'Port & Marine Works', icon: '⚓', group: G_CONSTRUCTION, prompt: 'Port and marine construction environment: quay walls and jetties being built over water, piling barges, gantry cranes and concrete caissons against the sea.' },
  { id: 'canal-water', label: 'Canal / Water Infrastructure', icon: '💧', group: G_CONSTRUCTION, prompt: 'Water infrastructure construction environment: concrete canals, culverts and treatment basins under construction, diversion channels, formwork and earth-moving along waterways.' },
  { id: 'pipeline-laying', label: 'Pipeline Laying', icon: '🧯', group: G_CONSTRUCTION, prompt: 'Pipeline laying environment: long trenches with large steel pipes being welded and lowered by sidebooms across open terrain, coating stations and a linear construction spread.' },
  { id: 'power-plant', label: 'Power Plant Construction', icon: '🏭', group: G_CONSTRUCTION, prompt: 'Power plant construction environment: massive turbine halls, cooling towers and boiler structures under erection, thick pipework, cranes and monumental industrial scale.' },
  { id: 'warehouse-logistics', label: 'Warehouse / Logistics Build', icon: '🏬', group: G_CONSTRUCTION, prompt: 'Warehouse and logistics construction environment: huge steel portal frames and cladding of a distribution center, vast concrete floor slabs and long-span roof structures.' },
  { id: 'stadium-arena', label: 'Stadium / Arena Construction', icon: '🏟️', group: G_CONSTRUCTION, prompt: 'Stadium and arena construction environment: sweeping curved roof trusses and tiered concrete seating bowls under construction, giant cranes and dramatic structural geometry.' },
  { id: 'night-construction', label: 'Nighttime Construction Site', icon: '🌙', group: G_CONSTRUCTION, prompt: 'Nighttime construction environment: a site lit by powerful floodlights and machinery headlights, glowing dust, long shadows, welding sparks and cranes silhouetted against a dark sky.' },

  ...
  return (
    ...
    >
      ...
      <main
        className={
          previewVideo
            ? 'min-h-screen px-0 pb-36 pt-14 sm:pb-40 sm:pt-16'
            : 'grid min-h-screen place-items-center px-4 pb-40'
        }
        aria-live="polite"
      >
        {previewVideo ? (
          <div className="relative h-[calc(100vh-9rem)] w-full sm:h-[calc(100vh-10rem)]">
            <div className="relative h-full w-full overflow-hidden bg-black">
              ...
              <div className="pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-black via-black/78 to-transparent px-4 pb-5 pt-12 sm:px-6 sm:pb-6">
                <div className="pointer-events-auto mx-auto flex w-full max-w-5xl flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                  <p className="max-w-3xl text-sm font-medium leading-6 text-zinc-100 sm:text-base">
                    {previewVideo.input_prompt}
                  </p>
                  <span className="inline-flex shrink-0 items-center gap-2 self-start rounded-full border border-white/10 bg-white/[0.06] px-3 py-1.5 text-xs font-semibold text-zinc-300 backdrop-blur">
      ...
      >
        <div className="flex flex-wrap items-center gap-2" aria-label="Clip duration">
          ...
          <p className="text-[11px] leading-5 text-zinc-500">
            Choose how long the generated clip should be.
          </p>
        </div>
